                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={handleChange}
                        rows={5}
                        className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-600 focus:border-transparent transition-colors resize-none ${
                    ...
                    <button
                      type="submit"
                      className="w-full md:w-auto px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all shadow-lg hover:shadow-xl flex items-center justify-center space-x-2"
                    >
              ...
              <div className="bg-gradient-to-br from-blue-600 to-blue-700 text-white rounded-xl p-8 shadow-lg">
                ...
                <div className="space-y-4">
                  <a
                    ...
                    className="flex items-start space-x-3 hover:text-blue-100 transition-colors"
                  >
                  ...
                  >
                    ...
                    <div>
                      ...
                      <div className="text-blue-100">support@nriservices.com</div>
                    </div>
                  </a>
