        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {testimonials.map((testimonial) => (
              <div
                key={testimonial.id}
                className="bg-white rounded-xl border-2 border-gray-100 p-8 hover:border-blue-600 hover:shadow-xl transition-all duration-300"
              >
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {[
              ...
              return (
                <div
                  key={service}
                  className="bg-white rounded-lg p-4 text-center border border-gray-200 hover:border-blue-600 hover:shadow-md transition-all"
                >
